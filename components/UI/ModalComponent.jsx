...
function ModalComponent({title, children, buttonLabel, confirmLabel, onConfirm, closeOnOverlayClick = true}) {

  const [isOpen, setIsOpen] = React.useState(false);

  if(!isOpen) return (
    <div>
        <ButtonComponent label={buttonLabel} onClick={() => setIsOpen(true)}/>
    </div>
  );
